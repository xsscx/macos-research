...
int initIPTelephony() {
  ...
  symbol_address = GetSymbolAddress(libip, "__ZNK21SipMessageEncodingMap12createHeaderERKNSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEES8_");
  if(!symbol_address) {
    printf("Symbol lookup failed\n");
    return 0;
  }
