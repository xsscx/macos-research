...
int initIPTelephony() {
  ...
  symbol_address = GetSymbolAddress(libip, "__ZN21SipMessageEncodingMap16addBodyPrototypeERKNSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEEP7SipBody");
  if(!symbol_address) {
    printf("Symbol lookup failed\n");
    return 0;
  }
