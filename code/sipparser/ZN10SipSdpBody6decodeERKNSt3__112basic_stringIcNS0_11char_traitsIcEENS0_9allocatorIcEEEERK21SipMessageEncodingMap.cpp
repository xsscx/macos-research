...
int initIPTelephony() {
  ...
  symbol_address = GetSymbolAddress(libip, "__ZN10SipSdpBody6decodeERKNSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEERK21SipMessageEncodingMap");
  if(!symbol_address) {
    printf("Symbol lookup failed\n");
    return 0;
  }
