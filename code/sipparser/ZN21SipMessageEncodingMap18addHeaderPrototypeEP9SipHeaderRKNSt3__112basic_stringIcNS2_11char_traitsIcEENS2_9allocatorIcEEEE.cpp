...
int initIPTelephony() {
  ...
  symbol_address = GetSymbolAddress(libip, "__ZN21SipMessageEncodingMap18addHeaderPrototypeEP9SipHeaderRKNSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE");
  if(!symbol_address) {
    printf("Symbol lookup failed\n");
    return 0;
  }
