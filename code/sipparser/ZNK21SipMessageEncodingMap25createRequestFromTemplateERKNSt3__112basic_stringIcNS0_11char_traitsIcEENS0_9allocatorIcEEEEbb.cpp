...
int initIPTelephony() {
  ...
  symbol_address = GetSymbolAddress(libip, "__ZNK21SipMessageEncodingMap25createRequestFromTemplateERKNSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEEbb");
  if(!symbol_address) {
    printf("Symbol lookup failed\n");
    return 0;
  }
